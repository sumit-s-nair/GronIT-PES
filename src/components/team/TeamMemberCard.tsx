...
export const TeamMemberCard: React.FC<{ member: TeamMember }> = ({ member }) => {
  return (
    <div className="module max-w-3xl"> {/* Even larger width */}
      <div className="content">
        <div className="relative w-72 h-72 mx-auto mb-8"> {/* Larger image size */}
          <Image
            src={member.image}
        ...
        <h2 className="text-3xl font-bold">{member.name}</h2> {/* Larger font size */}
        <div className="flex justify-center mt-8 space-x-8"> {/* Increased spacing between icons */}
